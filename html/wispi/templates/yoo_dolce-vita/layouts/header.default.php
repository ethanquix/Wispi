<div class="tm-headerbar tm-headerbar-default" <?php if ($this['config']->get('fixed_navigation')) echo 'data-uk-sticky'; ?>>
    ...
    <nav class="uk-navbar tm-navbar tm-navbar-default<?php if ($this['config']->get('dropdown_overlay')) echo ' tm-navbar-overlay-true'; ?> uk-hidden-small"
