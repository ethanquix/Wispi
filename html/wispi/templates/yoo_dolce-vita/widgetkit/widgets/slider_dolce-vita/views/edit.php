    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <h3 class="wk-form-heading">{{'Navigation' | trans}}</h3>
                ...
                <h3 class="wk-form-heading">{{'Size for before/after items' | trans}}</h3>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-item-size">{{'Scale' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-item-size" class="uk-form-width-medium" ng-model="widget.data['item_size']">
                            <option value="">{{'Normal' | trans}}</option>
                            <option value="95">{{'95%' | trans}}</option>
                            <option value="90">{{'90%' | trans}}</option>
                            <option value="85">{{'85%' | trans}}</option>
                            <option value="80">{{'80%' | trans}}</option>
                            <option value="75">{{'75%' | trans}}</option>
            ...
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <label><input type="checkbox" ng-model="widget.data['overlay_background']"> {{'Use a background color for the overlay' | trans}}</label>
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-overlay-position">{{'Position' | trans}}</label>
                    <div class="uk-form-controls">
