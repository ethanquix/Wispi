...
if ($settings['grid'] == 'dynamic') {
    ...
    $grid .= $settings['divider'] ? ' tm-grid-divider' : '';
...
<div id="wk-grid<?php echo $settings['id']; ?>" class="<?php echo $grid; ?> uk-text-<?php echo $settings['text_align']; ?> tm-grid-dolce-vita <?php echo $settings['class']; ?>" <?php echo $grid_js ?> <?php echo $animation; ?>>
...
<?php foreach ($items as $i => $item) :
        ...
        if ($settings['title_truncate']) {
           $title = Content::truncate($item['title'], $settings['title_truncate']);
        }

        // Content
        $content = $item['content'];
        if ($settings['content_truncate']) {
           $content = Content::truncate($item['content'], $settings['content_truncate']);
        }
        ...
        <div class="<?php echo $panel[$i % 2]; ?><?php echo $panel_hover; ?><?php if ($settings['animation'] != 'none') echo ' uk-invisible'; ?>">
            ...
            <div class="uk-margin uk-margin-bottom-small">
                <?php foreach ($item['tags'] as $tag) : ?>
                    <span class="uk-badge tm-badge-muted"><?php echo $tag; ?></span>
                <?php endforeach; ?>
            </div>
            <?php endif; ?>
            ...
            <h3 class="<?php echo $title_size; ?>">
                ...
                <?php if ($item['link']) : ?>
                    <a class="uk-link-reset" href="<?php echo $item->escape('link'); ?>"<?php echo $link_target; ?>><?php echo $title; ?></a>
                <?php else : ?>
                    <?php echo $title; ?>
                <?php endif; ?>
