    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.grid == 'default'" ng-model="widget.data['divider']">
                            <label><input type="checkbox" ng-model="widget.data['divider']"> {{'Show grid divider' | trans}}</label>
                        </p>
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label">{{'Title Truncate' | trans}}</label>
                    <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label">{{'Content Truncate' | trans}}</label>
                    <div class="uk-form-controls">
                        <label><input class="uk-form-width-mini" type="text" ng-model="widget.data['content_truncate']"> {{'Max. characters' | trans}}</label>
                    </div>
                </div>
