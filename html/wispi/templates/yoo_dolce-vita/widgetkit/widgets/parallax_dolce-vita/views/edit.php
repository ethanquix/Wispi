        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <input id="wk-background-color" class="uk-form-width-small" type="text" ng-model="widget.data['background_color_start']"> to
                        <input class="uk-form-width-small" type="text" ng-model="widget.data['background_color_end']"> ({{'e.g. %example%' | trans: {example:'#ff0000'} }})
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-image-blend-mode">{{'Image Blend Mode' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-image-blend-mode" class="uk-form-width-medium" ng-model="widget.data['image_blend_mode']">
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-image-opacity">{{'Image Opacity' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-image-opacity" class="uk-form-width-medium" ng-model="widget.data['image_opacity']">
                            <option value="">{{'Normal' | trans}}</option>
                            <option value="0.1">{{'90%' | trans}}</option>
                            <option value="0.2">{{'80%' | trans}}</option>
                            <option value="0.3">{{'70%' | trans}}</option>
                            <option value="0.4">{{'60%' | trans}}</option>
                            <option value="0.5">{{'50%' | trans}}</option>
                            <option value="0.6">{{'40%' | trans}}</option>
                            <option value="0.7">{{'30%' | trans}}</option>
                            <option value="0.8">{{'20%' | trans}}</option>
                            <option value="0.9">{{'10%' | trans}}</option>
                            <option value="1">{{'None' | trans}}</option>
                        </select>
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-contrast">{{'Contrast Color' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-contrast" class="uk-form-width-medium" ng-model="widget.data['contrast']">
                            <option value="">{{'Default' | trans}}</option>
                            <option value="secondary">{{'Contrast Secondary' | trans}}</option>
                            <option value="primary">{{'Contrast Primary' | trans}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-title-blur">{{'Blur' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-title-blur" class="uk-form-width-mini" type="text" ng-model="widget.data['title_blur_start']" placeholder="0"> to
                        <input class="uk-form-width-mini" type="text" ng-model="widget.data['title_blur_end']"> ({{'%from% to %to%' | trans: {from:'0', to:'20'} }})
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-content-blur">{{'Blur' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-content-blur" class="uk-form-width-mini" type="text" ng-model="widget.data['content_blur_start']" placeholder="0"> to
                        <input class="uk-form-width-mini" type="text" ng-model="widget.data['content_blur_end']"> ({{'%from% to %to%' | trans: {from:'0', to:'20'} }})
                    </div>
                </div>
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Badge' | trans}}</span>
                    <div class="uk-form-controls uk-form-controls-text">
